...
Bei Verwendung von nvme/tcp in K8s-Umgebungen mit langen Node-Namen können Pods nicht mit dem Storage verbunden werden.

.Behelfslösung
Verkürzen Sie den Node-Namen, sodass der Subsystemname weniger als 64 Zeichen enthält.
